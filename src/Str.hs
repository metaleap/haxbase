...
formatWithList :: (Text.Printf.PrintfType a, Text.Printf.PrintfArg t)=>  String  ->  [t]  ->  Maybe a
...
multiLinedChunksByIndent =
    let doesntbeginchunk "" = True ; doesntbeginchunk (c:_) = Data.Char.isSpace c
    in multiLinedChunksBy$ const.doesntbeginchunk
...
trimEnd =
    Lst.trimEnd Data.Char.isSpace

trimStart ::  String  ->  String
trimStart =
    Lst.trimStart Data.Char.isSpace
